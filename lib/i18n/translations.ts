...
export const translations = {
  en: {
      ...
      groups: [
        {
          ...
          items: ["VS Code", "Windows Terminal", "GitHub Copilot", "Warp"],
        },
        {
        ...
        },
        {
          ...
          items: ["Vercel", "Docker", "GitHub Actions", "Nginx"],
        },
        {
          title: "Design & Productivity",
          items: ["Figma", "Notion", "Linear", "Postman"],
        },
      ],
    },
    clientDeliverables: {
    ...
    contact: {
      ...
      booking: {
        title: "Book a Call",
        description: "Pick a time and I'll confirm by email.",
        name: "Your Name",
        email: "Your Email",
        topic: "What do you want to discuss?",
        date: "Date",
        time: "Time",
        notes: "Anything I should know? (optional)",
        submit: "Confirm Booking",
        submitting: "Booking...",
        success: "Booked! I'll see you then — a confirmation was recorded.",
  ...
  ar: {
    ...
    uses: {
      ...
      groups: [
        ...
        {
          title: "DevOps والاستضافة",
          items: ["Vercel", "Docker", "GitHub Actions", "Nginx"],
        },
        {
          title: "التصميم والإنتاجية",
          items: ["Figma", "Notion", "Linear", "Postman"],
        },
      ],
    },
    ...
    contact: {
      ...
      booking: {
        title: "احجز مكالمة",
        description: "اختار الميعاد اللي يناسبك وهأكده لك بالإيميل.",
        name: "اسمك",
        email: "إيميلك",
        topic: "عايز تتكلم في إيه؟",
        date: "التاريخ",
        time: "الوقت",
        notes: "أي حاجة عايز تقولها؟ (اختياري)",
        submit: "أكد الحجز",
        submitting: "جاري الحجز...",
        success: "تم الحجز! هشوفك في الميعاد ده.",
    ...
    about: {
      eyebrow: "نبذة عني",
      title: "المطور اللي وراء الشغل ده",
      intro:
